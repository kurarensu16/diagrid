...
-- Supporter status is changed exclusively by the admin-only RPC below.
...
-- Admin-only supporter badge management. Client-side claims are recorded as
-- feedback and must be reviewed before this function is called.
